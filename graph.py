...
class Graph: 
    ...
    def dataframe(self, all_data):
        overview_dict = {}
        
        daily_stats_df = ['date','sunrise time','sunset time', 'pressure', 'humidity', 'dew point', 'wind speed', 'clouds', 'uvi']
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    def chart_temp_overview(self, df):
        ...
        code_path = os.path.abspath('graphs library') # Figures out the absolute path for you in case your working directory moves around.
    ...
    def temp_overview(self, all_data): 
        ...
        for x in range(0,8):#for loop for the temp_avg's
            for data_key,key_name in zip(time_of_day,temps_fl): 
                value = (all_data['daily'][x]['temp'][data_key] - 273.15)
                overview_dict[key_name].append(round(value))
